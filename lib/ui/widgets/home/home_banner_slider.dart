      ...
      children: [
            ...
            return Builder(
              builder: (BuildContext context) {
                return Container(
                  ...
                  image: DecorationImage(image: NetworkImage(i.img!.toString()),),),
        ...
        ValueListenableBuilder(
          ...
          builder: (context, updateValue, _) {
            if (productSliderModel.data == null || productSliderModel.data!.isEmpty) {
...
//
// class HomeBannerSlider extends StatelessWidget {
//   HomeBannerSlider({ required this.productSliderModel}) ;
//
//   final CarouselController _carouselController = CarouselController();
//   final ValueNotifier<int> CurrentSelectedIndex = ValueNotifier(0);
//   final ProductSliderModel productSliderModel;
...
//                     borderRadius: BorderRadius.circular(5),
//                     color: AppColor.primaryColor.withOpacity(0),
//                     image: DecorationImage(image: NetworkImage(i.image.toString())),
//                   ),
//                   alignment: Alignment.center,
//                 );
//               },
